...
check_MEME_parlmembers_have_party <- function(RESE, MEME) {
  ...
  parl_persons <- unique(RESE$pers_id[
    RESE$political_function %in% c("NT_LE-LH_T3_NA_01", "NT_LE_T3_NA_01", "NT_LE_T3_NA_09", "NT_LE_T3_NA_11", "NT_LE-LH_T3_NA_11")
  ])
...
check_MEME_parlmembers_have_party_details <- function(RESE, MEME) {
  ...
  parl_rows <- RESE[RESE$political_function %in% c("NT_LE-LH_T3_NA_01", "NT_LE_T3_NA_01", "NT_LE_T3_NA_09", "NT_LE_T3_NA_11", "NT_LE-LH_T3_NA_11"), , drop = FALSE]
